...
public enum UserErrorCode implements BaseErrorCode {
    ...
    INVALID_LOGIN_INFO(HttpStatus.UNAUTHORIZED, "USER401_2", "이메일 또는 비밀번호가 올바르지 않습니다."),
    ...
    REQUIRED_TERMS_NOT_AGREED(HttpStatus.BAD_REQUEST, "USER400_2", "필수 약관에 모두 동의해야 합니다.");
